...
# API credentials
INSTAGRAM_ACCESS_TOKEN = "EABfwuAuOCQ8BOyOkHVZBvG09c0icqh6qobZA1bZAU0BEKt41i3BzPk3mgIDyZCXLtzDmwe9arY5asR30FlWd7WvDwiYp4PObmXy3IGm1KGVT6qpQ1w81UAKsopOPZBJJqEwhyVrhs0BXJGonGM1pgBgODo0vbYZADXalBZC15FdVQ3j7qAdvVIEWa7yMnqyGKWjfiI6RVgDLRvrrkb2TwZDZD"
...
def automate_instagram_post(rss_url):
    try:
        ...
        if not image_url:
            print("No image found, generating one with DALL-E.")
